<?php 
    ...
    if (!isset($_POST['boton'])){
        //total de registro
        $TotalRegistros= ContarBusquedaFiscalia($_POST['buscar'], $_POST['FiscNombres'], $_POST['FiscApellidos'], ALL, 0);
...
<html>
    ...
    <body>
        <div align="center"> <h3>Búsqueda en Fiscalías</h3> </div>
        ...
        <table align="center" border="1" id="tblBuscar" class="TablaCaja">
            <tbody>
                ...
                <?php
                    ...
                    $regDenuncias= BusquedaFiscalia($_POST['buscar'], $_POST['FiscNombres'], $_POST['FiscApellidos'], $limit, $offset);
                ...
                ?>        
                            ...
                            <td><?php echo $fila["denuncia"]; ?> </td>
                            <td><?php echo $fila["nombre_imputado"]; ?></td>
                            <td><?php echo $fila["delito"]; ?></td>"   
                            <td><?php echo $fila["fiscalia"]; ?></td>
                            <td><?php echo $fila["fasignado"]; ?></td>
