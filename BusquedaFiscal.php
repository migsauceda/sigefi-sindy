<?php 
    ...
    if (!isset($_POST['boton'])){ 
        //total de registro
        $TotalRegistros= ContarBusquedaFiscal($_POST['buscar'], $_POST['FiscNombres'], $_POST['FiscApellidos'], ALL, 0);
        ...
        <table align="center" border="1" id="tblBuscar" class="TablaCaja">
            <tbody>
                <tr class="SubTituloCentro">
                    ...
                    <th><strong>Fiscal asignado</strong></th>
                ...
                <?php
                    ...
                    $regDenuncias= BusquedaFiscal($_POST['buscar'], $_POST['FiscNombres'], $_POST['FiscApellidos'], $limit, $offset);
