...
$sql= "SELECT usuario, contrasena, ubicacion, nombreapellido 
        FROM tbl_usuarios WHERE usuario='$Usr'";
...
//        }
        ...
        if($valor[0]== 'f'){
			...
			$sql="update tbl_usuarios set pedircambiopasswd='f' where pedircambiopasswd='t' and usuario='$Usr'";
			$resultado= $oConeccion->ejecutarComando($sql);
            echo
            "<script>
