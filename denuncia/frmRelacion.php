...
//    $_SESSION['oRelaciones']= 't';
    //si ya se ha guardado relaciones para esta denuncia
    if(isset($_SESSION["oRelaciones"])){ 
        if ($_SESSION['oRelaciones']== 't'){ 
            $oRelaciones= null;
            $RelacionesDenunciante= null;
            $RelacionesOfendido= null;
...
//                            echo "impu: ".$row['nimputadoid']." ofe: ".$row['nofendidoid'];
                            if ($imputado_val[$contaofendido]== $row['nimputadoid'] && 
                                $ofendidos_val[$j]== $row['nofendidoid']){ 
                                $parentesco= $row['nparentescoid']; echo $parentesco;
                                echo "<script type=\"text/javascript\">";
