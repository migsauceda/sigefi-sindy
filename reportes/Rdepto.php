...
<html lang="es">
<head>
<title>Reporte por Depto, Municipios y Aldea del Imputado con un Rango de Fechas </title>
<meta charset = "utf-8">
...
<body>
    <header>
        ...
        <h2>Reporte por Depto, Municipios y Aldea del Imputado con un Rango de Fechas </h2>
        </div>
    </header>
    <form method="POST" class="form" action="">
          ...
          if (isset($_POST['generar']))
          {
               ...
               echo '<div align="center"><a type="button" href="deptoexcel.php?fecha1='.$_fecha_inicial.'&fecha2='.$_fecha_final.'" target="blank" class="btn btn-success">Exportar a Excel</a></div>
