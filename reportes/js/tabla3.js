...
function addRowToTable()
{
  ...
  // si no hay fila de encabezado en la tabla, entonces la iteración = lastRow + 1
  ...
  sel.name = 'usuario' + iteration;
  sel.id = 'usuario' + iteration;
  sel.options[0] = new Option('---', '---');
  sel.options[1] = new Option('Todos','todos');
  var elemento=document.getElementById('usuario1')
  var i=0
  ...
  var sel = document.createElement('select');
  sel.name = 'sede' + iteration;
  sel.id = 'sede' + iteration;
  sel.options[0] = new Option('---', '---');
  sel.options[1] = new Option('Todas','todas');
  var elemento=document.getElementById('sede1')
  var i=0
  for (i=2; i<elemento.length; i++){
	  sel.options[i] = new Option(elemento.options[i].text, elemento.options[i].value);
  }
