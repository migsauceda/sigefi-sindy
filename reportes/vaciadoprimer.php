...
<body>
    ...
    <form method="POST" class="form" action="">
          ...
          if (isset($_POST['generar']))
          {
               ...
               echo '<div align="center"><a type="button" href="vaciado.php?fecha1='.$_fecha_inicial.'&fecha2='.$_fecha_final.'" target="blank" class="btn btn-success">Exportar a Excel</a></div>
  ...
  eco_denunte.cdescripcion as eco_denunte
