...
//    $pcboDepto2= '%';    
    ...
    $where= " tbl_imputado.tdenunciaid= tbl_imputado_delito.tdenunciaid and 
        tbl_departamentopais.cdepartamentoid = tbl_municipio.cdepartamentoid AND
...
$sql= "SELECT 
count(tbl_imputado.crangoedad) as frecedad,
case when crangoedad= 'a' then 'adulto' 
when crangoedad= 'am' then 'adulto mayor' 
when crangoedad= 'a' then 'adulto' 
...
count(tbl_imputado.cgenero) frecsexo,
case when tbl_imputado.cgenero= 'm' then 'masculino'
when tbl_imputado.cgenero= 'f' then 'femenino'
else 'no consignado'
end as sexo, 
tbl_delito.cdescripcion as delito, tbl_departamentopais.cdescripcion as departamento, 
tbl_municipio.cdescripcion as municipio, tbl_aldea.cdescripcion as ciudad, tbl_barrio.cdescripcion as barrio 
...
while($fila = pg_fetch_array($resultado)){    
    $html.= "<tr> ";
        $html.= "<td>$fila[departamento] $fila[municipio] $fila[ciudad] $fila[barrio]</td>";        
    $html.= "</tr> <tr>";
        $html.= "<td>Delito: $fila[delito], Rango de edad: $fila[frecedad] $fila[edad], Sexo: $fila[frecsexo] $fila[sexo]<br></td>";
    $html.= "</tr> ";
