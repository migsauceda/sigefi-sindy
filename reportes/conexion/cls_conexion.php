...
class cls_conexion extends Config {
    private $link;
	
    function __construct(){}
   
    public function conectar() {
		$String_conexion="host=".parent::getServidor()." port=".parent::getPuerto()." dbname=".parent::getBaseDatos()." user=". parent::getUsuario()." password=".parent::getContrasena();
