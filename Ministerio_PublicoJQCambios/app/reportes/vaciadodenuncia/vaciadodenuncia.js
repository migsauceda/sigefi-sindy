...
$('body').on('click','.buscarvaciado',function(e){
    ...
    if(typeof(fechainicio)=='undefined' || fechainicio=='' || typeof(fechafinal)=='undefined' || fechafinal=='' && delito>=0 ){
      
             getallvaciardenucia('vaciadodenuncia',delito);
			
            
       }
     if(delito==-2 && fechainicio=='' && fechafinal=='' ){
        getallvaciardenuciatodosdelitos('vaciadodenunciatodosdelitos');
      }
   // else{
    if(delito>0 && (typeof(fechainicio)!='undefined' || fechainicio!='') && (typeof(fechafinal)!='undefined' || fechafinal!='') && fechainicio<fechafinal){
   ...
   if(delito>0 && (typeof(fechainicio)!='undefined' || fechainicio!='') && (typeof(fechafinal)!='undefined' || fechafinal!='') && fechainicio>fechafinal){
    ...
    if(delito==-2 && (typeof(fechainicio)!='undefined' || fechainicio!='') && (typeof(fechafinal)!='undefined' || fechafinal!='') && fechainicio<fechafinal){

               getallvaciardenuciatododelitosfechas('vaciadodenunciatodosdelitos',fechainicio,fechafinal);
...
$.getJSON(serverUrl+api+'/'+delito, function(data) {
    ...
    if(data.status==200){
        $('#VaciadoDenunciaT').dataTable({
            ...
            //agregue
            { data: "edaddenunciante"},
            { data: "direcciondenunciante"},
            { data: "sexodenunciante"},
            {data:"generodenunciante"},
            ...
            { data: "generoimputado"},
            { data: "edadimputado"},
            { data: "direccionimputado"},
            { data: "orientacionsexualimputado"},
            { data: "telefonoimputado"},
            { data: "aplicalgbtiimputado"},
            { data: "aliasimputado"},
            { data: "nombreasumidoimputado"},
            { data: "condisionimptado"},
            { data: "trabajoremuneradoimputado"},
            { data: "asisteeducacionimputado"},
            { data: "infractorimputado"},
            //-------------------
...
function getallvaciardenuciatodosdelitos(api){
...
function getallvaciardenuciatododelitosfechas(api,fechainicio,fechafinal){

 
         $.getJSON(serverUrl+api+'/'+fechainicio+'/'+fechafinal, function(data,status) {
          if(data.status==200){
                $('#VaciadoDenunciaT').dataTable({
                    dom: 'Bfrtip',
                    buttons: [
    ...
    /*if(typeof(municipio)=='undefined' || municipio==-1){
        ...
        $.getJSON(serverUrl+api, function(data,status) {
            if(data.status==200){
                ...
                $('#delito').append('<option value="-2">Todos Delitos</option>');
                    $.each(data.resdato, function( key, val ) {
