                     ...
                     <div class="form-group ">
                      ...
                      <div class="form-group ">
                       ...
                       <div class="form-group ">
                        ...
                        <div class="form-group ">
                                <button class="btn-primary <input type="hidden" id="usersesion" clase="usersesion" value="<?php echo $var->getUsuario(); ?>">
<input type="hidden" id="ipreal" clase="ipreal" value="<?php echo $var->getRealIP(); ?>">buscar_actividadfiscal"> Buscar</button>
                        </div>
