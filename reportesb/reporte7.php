...
fiscalia_imputado, tbl_imputado.bconocido as conocido_imputado, tbl_imputado.calias as 
...
tbl_ofendido.bvive as vive_ofendido, tbl_ofendido.bconocido as conocido_ofendido, 
tbl_ofendido.crepresentantelegal as representante_legal_ofendido, 
tbl_ofendido.cesmenor as menor_ofendido from tbl_denuncia inner join tbl_denunciante on 
...
tbl_denuncia.tdenunciaid=tbl_ofendido.tdenunciaid inner join tbl_denuncia_imputado on 
tbl_denuncia.tdenunciaid=tbl_denuncia_imputado.tdenunciaid inner join tbl_denuncia_ofendido on 
tbl_denuncia.tdenunciaid=tbl_denuncia_ofendido.tdenunciaid where tbl_denuncia.tdenunciaid='$denuncia'";
...
$consulta2="select tbl_denuncia.tdenunciaid, tbl_delito.ndelitoid, tbl_delito.cdescripcion from tbl_denuncia inner join tbl_imputado_delito on 
...
$resultadoDelitos=$conexion->consultar($consulta2);
//------------------fin consultas de la denuncia
...
$pdf->SetHeaderData('mp_logo.png', '30', 'Expediente completo', 'Fecha: '.$fecha.'  Hora: '.$hora.'               Usuario: '.$usuario);
...
//----------------------muestra datos de la denuncia original
...
//----------------------------------fin de mostrar datos de la denuncia original

//----------------------------muestra datos de la actividad fiscal
$resultado=$conexion->consultar("select tbl_denuncia.tdenunciaid, tbl_denuncia_imputado.tpersonaid as imputado, 
...
from tbl_denuncia inner join tbl_denuncia_imputado on tbl_denuncia.tdenunciaid=
tbl_denuncia_imputado.tdenunciaid inner join tbl_imputado_fiscal on tbl_denuncia.tdenunciaid=
...
inner join tbl_imputado on tbl_denuncia_imputado.tpersonaid=tbl_imputado.tpersonaid 
...
$fiscalAnt="";
$denunciadoAnt="";
$html.="Datos de la actividad Fiscal<br><br>";
while ($row=pg_fetch_assoc($resultado)){
	$etapa=$row['netapaid'];
...
//----------------------------fin de mostrar datos de la actividad fiscal

//------------------------------mostrar denuncia con datos ya modificados segun investigacion
$resultado=$conexion->consultar($consulta);	
$resultado1=$conexion->consultar($consulta);
$resultado2=$conexion->consultar($consulta);
$resultado3=$conexion->consultar($consulta);
...
if (pg_num_rows($resultado)>0){
	$html.='<br>Datos de la Denuncia<br><br>
			<table align="center" border="1">			
				<tr>
					<td width="10%">Denuncia</td>
					<td width="14%">Fecha Denuncia</td>
...
//-----------------------fin de mostrar denuncia con datos ya modificados segun investigacion
...
$pdf->Output('Expediente completo '.$denuncia.'.pdf', 'I');
