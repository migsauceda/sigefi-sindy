		...
		if ($opcion==3){	
			...
			if ($existeTodas==True){ //todas las sedes
						...
						for ($i=1;$i<=$numFiltros;$i++){
							if (($fechasIni[$posArreglo]!="") && ($fechasFin[$posArreglo]!="") && ($sedes[$posArreglo]!="") && ($usuarios[$posArreglo]!="")){
								if ($todosUsuario==True){//todos los usuarios
									$condiciones[$posArreglo]="tbl_controlestados.fecha>='$fechasIni[$posArreglo]' and tbl_controlestados.fecha<='$fechasFin[$posArreglo]'";
								}else{//un usuario en especifico
									$condiciones[$posArreglo]="tbl_controlestados.fecha>='$fechasIni[$posArreglo]' and tbl_controlestados.fecha<='$fechasFin[$posArreglo]' and tbl_controlestados.usr='$usuarios[$posArreglo]'";
								}							
							}
						...
						for ($i=1;$i<=$numFiltros;$i++){
							if (($fechasIni[$posArreglo]!="") && ($fechasFin[$posArreglo]!="") && ($sedes[$posArreglo]!="") && ($usuarios[$posArreglo]!="")){	
								if ($todosUsuario==True){//todos los usuarios
									$condiciones[$posArreglo]="tbl_controlestados.fecha>='$fechasIni[$posArreglo]' and tbl_controlestados.fecha<='$fechasFin[$posArreglo]' and 
	tbl_lugarrecepcion.nlugarid='$sedes[$posArreglo]'";
								}else{//un usuario en especifico de una sede
									$condiciones[$posArreglo]="tbl_controlestados.fecha>='$fechasIni[$posArreglo]' and tbl_controlestados.fecha<='$fechasFin[$posArreglo]' and 
	tbl_lugarrecepcion.nlugarid='$sedes[$posArreglo]' and tbl_controlestados.usr='$usuarios[$posArreglo]'";
								}
							}
