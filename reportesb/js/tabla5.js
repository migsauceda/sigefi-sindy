...
function addRowToTable()
{
  ...
  // si no hay fila de encabezado en la tabla, entonces la iteraciÃ³n = lastRow + 1
  ...
  var RightSel = row.insertCell(1);
  var sel2 = document.createElement('select');
  sel2.name = 'fiscalia' + iteration;
  sel2.id = 'fiscalia' + iteration;
  sel2.options[0] = new Option('---', '---');
  sel2.options[1] = new Option('Todas','todas');
  var elemento=document.getElementById('fiscalia1')
  var i=0
  for (i=2; i<elemento.length; i++){
	  sel2.options[i] = new Option(elemento.options[i].text, elemento.options[i].value);
  }  
  sel2.onchange=function() {llena_cboFiscal1(this.value, sel2.id)}
  RightSel.appendChild(sel2);
  
  var RightSelf = row.insertCell(2);
  var self = document.createElement('select');
  self.name = 'fiscal' + iteration;
  self.id = 'fiscal' + iteration;
  self.options[0] = new Option('---', '---');
  contenedor = document.createElement('div'); 
  contenedor.id = (iteration+1); 
  RightSelf.appendChild(contenedor);
  var elemento=document.getElementById((iteration+1));
  elemento.appendChild(self);
  
  //celda de la derecha
  var cellRight = row.insertCell(3);
  var el = document.createElement('input');
  el.type = 'text';
  el.name = 'fechaIni' + iteration;
  el.id = 'fechaIni' + iteration;
  el.size = 10;
  el.readOnly=true;
  var btn = document.createElement('input')
  btn.type= 'button'
  btn.value= '...'
  btn.id = 'btn' + iteration
  btn.name = 'btn' + iteration
  btn.onclick= function() {popUpCalendar1(this, el, "yyyy-mm-dd")};
  
  cellRight.appendChild(el);
  cellRight.appendChild(btn);  
  
  // seleccionar la celda
  var cellRightSel = row.insertCell(4);
  var el2 = document.createElement('input');
  el2.type = 'text';
  el2.name = 'fechaFin' + iteration;
  el2.id = 'fechaFin' + iteration;
  el2.size = 10;
  el2.readOnly=true;
  ...
  btn2.type= 'button'
  btn2.value= '...'
  btn2.id = 'btn2_' + iteration
  btn2.name = 'btn2_' + iteration
  btn2.onclick= function() {popUpCalendar2(this, el2, "yyyy-mm-dd")};
  
  cellRightSel.appendChild(el2);
  cellRightSel.appendChild(btn2);
  
  var cellRightSel2 = row.insertCell(5);
  var sel = document.createElement('select');
  sel.name = 'estado' + iteration;
  sel.id = 'estado' + iteration;
  sel.options[0] = new Option('---', '---');
  var elemento=document.getElementById('estado1')
  var i=0
  for (i=1; i<elemento.length; i++){
	  sel.options[i] = new Option(elemento.options[i].text, elemento.options[i].value);
  }
  cellRightSel2.appendChild(sel);
}

function llena_cboFiscal1(fiscalia, id){
	if (fiscalia!='---'){
...
//Dentro de el siguiente ciclo se generan los aÃ±os, en el caso de que sea introcir fecha de nacimiento restale 30---- i>=(yearNow-30)-----
//CAMBIA el siguiente for por este " for	(i=yearNow; i<=(yearNow+4); i++) { " si quieres que los aÃ±os empizen en el actual en adelante		
...
//------------------------------------TERMINAR LA FUNCION EN 0 PARA QUE INICIE EN EL DIA ACTUAL EN LA SIGUIENTE LINEA----------------------------------------------
	...
	function popUpCalendar1(ctl, ctl2, format) {
		...
		var	toppos=-10
		//var ctl=elementoBtn
		//var pos=document.getElementById('fechaIni'+iteration)
		//var ctl2=txt
		//alert(btn.name)
		//alert(txt.name)
...
//------------------------------------TERMINAR LA FUNCION EN 0 PARA QUE INICIE EN EL DIA ACTUAL EN LA SIGUIENTE LINEA----------------------------------------------
	...
	function popUpCalendar2(ctl, ctl2, format) {
		var	leftpos=-190
		var	toppos=-10
		/*var ctl=elementoBtn2
		var ctl2=elementoTxt2
		var format="dd-mm-yyyy"*/
...
//----------------------------Eliminar las siguientes lineas para activar todos los dias del aÃ±o-----y retornar un false-----------------------------------------
