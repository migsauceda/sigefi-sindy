...
<html>
    ...
    <body>
<h3 style="text-transform:uppercase"><center>Frecuencia de denuncias capturadas en cada lugar de recepci&oacute;n, por rango de fechas</center></h3><br><br>
<center><table border="1" id="tabla">
<tr>
	<th colspan="2" align="center">Fecha Inicial</th>
...
<tr>
    ...
    <input type="button" name="buscar" id="buscar" value="Buscar" onClick="buscar_rpt2(fechaIni1.value, fechaFin1.value, sede1.value)"></center>
<br><br>
