...
if($_POST[DenuncianteJur]== 'juridico'){ 
    ...
    if ($TipoDoc== "identidad"){
        ...
        $objDenunciante->setTipoDocumento(1);
    }
    ...
    elseif ($TipoDoc== "colegio"){
        ...
        $objDenunciante->setIdentidad($_POST[txtRtn]);
    ...
    $objDenunciante->setPersonaNatural(0);
}else
{ 
    $objDenunciante->setPersonaNatural(1); 
