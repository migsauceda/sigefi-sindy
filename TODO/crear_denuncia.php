                ...
                $( "#tabs" ).tabs({
                    beforeLoad: function(event, ui){
                        ui.jqXHR.error(function(){
                            ui.panel.html("Error al recuperar la información, "+
                               "Seleccione la opción Crear Nueva del menú Denuncias");
                        });
                    }
                });                
            });        
...
<body>   
    ...
    <div id="tabs">
            <ul>
                    <li><a href="generales/generales.php">Generales</a></li>
                    <li><a href="denunciante/denunciante.php">Denunciante</a></li>
                    <li><a href="imputado/imputado.php">Denunciado</a></li>
                    <li><a href="ofendido/ofendido.php">Ofendido</a></li>
